            ...
            <ul>
                ...
                <li class="drop-down"><a href="javascript:;">Services</a>
                    <ul>
                        ...
                        <li><a href="javascript:;">CCTV Surveillance System</a></li>
                        <li><a href="javascript:;">Home/Commercial Security Alarm System</a></li>
                        <li><a href="javascript:;">Access Control System</a></li>
                        <li><a href="javascript:;">Miscellaneous</a></li>
                    </ul>
                </li>
